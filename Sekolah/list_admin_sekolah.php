...
$iduser = $_GET['iduser'];
$sql = "SELECT * FROM users u INNER JOIN info_sekolah s on u.id_users= s.users_id_users INNER JOIN foto_sekolah f on s.npsn = f.info_sekolah_idinfo_sekolah WHERE u.id_users =". $iduser ." GROUP by s.npsn";
...
if ($result->num_rows > 0) {		
	...
	while ($obj = $result->fetch_assoc()) {
        ...
        $list_sekolah[$i]['keterangan'] = addslashes(htmlentities($obj['keterangan_status_sekolah'])); 
